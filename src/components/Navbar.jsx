          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-xxl-5">
              <img
                src={logo}
                alt=""
                className="z_11 position-relative crsor_pointer"
              />
              <div
              ...
              >
                <ul className="d-flex flex-column flex-xl-row gap-xl-4 gap-2 mb-0 ">
                  <li>
                    <a
                      href="#"
                      className="ff_gilroy fw_400 text_hover fs_base text_hover text-white"
                    >
                      WordPress Solution
                      <svg
                        className="ms-2"
                  ...
                  <li>
                    <a
                      href="#"
                      className="ff_gilroy fw_400 text_hover fs_base text-white"
                    >
                      Services
                      <svg
                        className="ms-2"
                  ...
                  <div className="d-flex flex-column d-xl-none">
                    <p className="ff_gilroy fw_400  fs_base mt-4 text-white">
                      1 888 266-6917 (eu?)
                    </p>
                    <button className="ff_gilroy fw_600 fs_lg btn_contact border-0 rounded-pill text-white">
                      Contact Us
                    </button>
                    <p className="ff_gilroy fw_400 mt-4 fs_base text-white">
                      <svg
                        className="me-1"
                        width="24"
                        height="24"
            ...
            <div className="d-flex gap-4 align-items-center d-none d-xl-inline-flex">
              ...
              <p className="mt-3">
                ...
                <a
                  href=""
                  className="ff_gilroy fw_400 fs_base text_hover text-white"
                >
                  Eng
                  <svg
                    className="ms-2"
